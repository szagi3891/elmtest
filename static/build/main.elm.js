...
var _user$project$Main$GetErr = function (a) {
	return {ctor: 'GetErr', _0: a};
};
var _user$project$Main$GetOk = function (a) {
	return {ctor: 'GetOk', _0: a};
};
var _user$project$Main$commandFromUrl = function (url) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Main$GetErr,
		_user$project$Main$GetOk,
			...
			case 'Get':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{resp: 'trwa ładowanie'}),
					_1: _user$project$Main$commandFromUrl('http://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=cats')
				};
			case 'ResetGet':
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$ResetGet = {ctor: 'ResetGet'};
var _user$project$Main$Change3 = function (a) {
	return {ctor: 'Change3', _0: a};
};
var _user$project$Main$Get = {ctor: 'Get'};
var _user$project$Main$Change2 = function (a) {
	return {ctor: 'Change2', _0: a};
};
var _user$project$Main$Change1 = function (a) {
	return {ctor: 'Change1', _0: a};
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(_user$project$Main$Change1)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.message1)
					])),
				A2(
				_elm_lang$html$Html$textarea,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(_user$project$Main$Change2)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.message2)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$String$reverse(model.message1))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								ctor: '_Tuple2',
								_0: 'color',
								_1: _user$project$Main$getStyle(model)
							}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Zrób request')
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$ResetGet)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('reset')
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(_user$project$Main$Change3),
						_elm_lang$html$Html_Attributes$style(
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.resp)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'white-space', _1: 'pre-line'},
								{ctor: '_Tuple2', _0: 'word-break', _1: 'break-all'},
	...
	main: _elm_lang$html$Html_App$program(
		{
			init: {
				ctor: '_Tuple2',
				_0: {count: 0, message1: 'init', message2: 'init', resp: '...'},
				_1: _elm_lang$core$Platform_Cmd$none
			},
